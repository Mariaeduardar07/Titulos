       ...
       <main className={styles.main}>
         <section className={styles.featured}>
           ...
           <div className={styles.featuredTrophies}>
            <Card ano={2012} capa="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/FIFA_CLUB_WORLDCUP.jpg/450px-FIFA_CLUB_WORLDCUP.jpg" detalhes={"Corinthians 2 x 0 Boca Juniors"} textoAlt={"Troféu do Mundial Interclubes 2012"} titulo={"Mundial de Clubes da FIFA"} />
